...
export class ModelsConfigureSetup extends connect(store)(PageViewElement) {
    ...
    protected render() {
        ...
        <div style="margin-top: 1em;">
            <wl-button style="float:right;" @click="${this._edit}" ?disabled=${!this.user}>
                <wl-icon>edit</wl-icon>&ensp;Edit
            </wl-button>
            <wl-button style="--primary-hue: 0; --primary-saturation: 75%" @click="${this._delete}" ?disabled=${!this.user}>
